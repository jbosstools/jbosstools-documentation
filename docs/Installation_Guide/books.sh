...
function make {
	...
	#echo 'Now edit Red_Hat_JBoss_Developer_Studio_Installation_Guide/en-US/Book_Info.xml by hand'

	#give feeback
	echo '[INFO] ------------------------------------------------------------------------'
	echo '[INFO] Making books has FINISHED'
	echo '[INFO] Now edit Installation_Guide/en-US/Author_Group.xml by hand'
	echo '[INFO] Now edit Red_Hat_JBoss_Developer_Studio_Installation_Guide/en-US/Book_Info.xml by hand'	
	echo '[INFO] ------------------------------------------------------------------------'	
