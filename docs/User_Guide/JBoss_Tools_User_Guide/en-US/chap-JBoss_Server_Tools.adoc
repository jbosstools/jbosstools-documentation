...
within the IDE, as detailed in the itemizedlist below.
...
as detailed in the itemizedlist below. Note that complete server
...
4.  Depending on the outcome of the scan, follow the appropriate
listitem:
+
...
itemizedlist below details the process for creating new server runtime
...
detailed in the itemizedlist below.
...
server, as detailed in the itemizedlist below.
